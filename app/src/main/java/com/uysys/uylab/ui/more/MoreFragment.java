...
import com.uysys.uylab.ui.upcomming_batch.Upcoming_batch_fragment;

public class MoreFragment extends BaseFragment {
    private View view;
    //private Button applyBtn;
    private View mentorsView;
    private View terms_and_condition_view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        terms_and_condition_view = view.findViewById(R.id.terms_and_conditions_id);
        upcoming_batch_view = view.findViewById(R.id.upcoming_batch);
...
//        });
        ...
        terms_and_condition_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (getFragmentListener() != null) {
        ...
        upcoming_batch_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (getFragmentListener() != null) {
                    Upcoming_batch_fragment fragment = new Upcoming_batch_fragment();
                    fragment.setFragmentListener(getFragmentListener());
                    getFragmentListener().onAddFragment(fragment);
                }
            }
